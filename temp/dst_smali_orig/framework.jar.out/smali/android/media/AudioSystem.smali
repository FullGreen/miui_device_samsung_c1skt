...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/media/AudioSystem$EffectSessionCallback;
    }
.end annotation
...
.field private static sEffectSessionCallback:Landroid/media/AudioSystem$EffectSessionCallback;
...
.method private static effectSessionCallbackFromNative(IIIZ)V
    .locals 4
    .param p0, "event"    # I
    .param p1, "stream"    # I
    ...
    .local v0, "cb":Landroid/media/AudioSystem$EffectSessionCallback;
    const-class v2, Landroid/media/AudioSystem;

    monitor-enter v2

    :try_start_0
    sget-object v1, Landroid/media/AudioSystem;->sEffectSessionCallback:Landroid/media/AudioSystem$EffectSessionCallback;

    if-eqz v1, :cond_0

    sget-object v0, Landroid/media/AudioSystem;->sEffectSessionCallback:Landroid/media/AudioSystem$EffectSessionCallback;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .end local v0    # "cb":Landroid/media/AudioSystem$EffectSessionCallback;
    :cond_0
    monitor-exit v2
    ...
    const-string v3, "effectSessionCallbackFromNative: unknown event "
    ...
    .restart local v0    # "cb":Landroid/media/AudioSystem$EffectSessionCallback;
    :catchall_0
    move-exception v1
    ...
    invoke-interface {v0, p1, p2}, Landroid/media/AudioSystem$EffectSessionCallback;->onSessionAdded(II)V

    goto :goto_0

    :cond_2
    invoke-interface {v0, p1, p2}, Landroid/media/AudioSystem$EffectSessionCallback;->onSessionRemoved(II)V
...
.method private static final native native_register_effect_session_callback()V
.end method
...
.method public static setEffectSessionCallback(Landroid/media/AudioSystem$EffectSessionCallback;)V
    .locals 2
    .param p0, "cb"    # Landroid/media/AudioSystem$EffectSessionCallback;
    ...
    :try_start_0
    sput-object p0, Landroid/media/AudioSystem;->sEffectSessionCallback:Landroid/media/AudioSystem$EffectSessionCallback;

    invoke-static {}, Landroid/media/AudioSystem;->native_register_effect_session_callback()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
